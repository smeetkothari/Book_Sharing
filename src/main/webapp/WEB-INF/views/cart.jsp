...
<div id="wrapper">
  ...
  <table id="keywords" cellspacing="0" cellpadding="0">
	...
	<tr>
	 ...
	 <c:forEach var="n" items="${sessionScope.cartid}">
	...
	<td class="lalign"><a href="search?id=${n.notesid}">Remove from bag</a></td>
		...
		<input type="submit" value="Check Out" name="buy" class = "tfbutton">
		</c:if>
		</form> 
