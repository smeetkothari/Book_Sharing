...
<div id="wrapper">
  ...
  <table id="keywords" cellspacing="0" cellpadding="0">
    ...
    <th><span>Share Time</span></th>
    <th><span>Share Date</span></th>
  ...
  <c:forEach var="n" items="${list}">
	 ...
	 <tr>       
			<form method="post">
    			...
    			<td class="lalign">${n.user.name}</td>
    			<td class="lalign">${n.stime}</td>
    			<td class="lalign">${n.sdate}</td>
    			<td class="lalign">${n.notes.user.name}</td>
    			<td class="lalign"><input type="submit" value="View" name="viewthenote"></td>
    		
            	
            	<input type="hidden" value="${n.notes.notesid}" name="hide">
       		</form>       
     </tr>  
